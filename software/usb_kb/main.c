...
#define addr			(volatile char*)	0x50
#define red			(volatile char*)	0x40 //FOR SOME REASON CS BASE BEHAVES WEIRDLY MIGHT HAVE TO SET MANUALLY
#define green			(volatile char*)	0x30
#define blue			(volatile char*)	0x20
